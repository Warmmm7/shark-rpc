...
public class SpiLoader {
     ...
     * 已经加载的类
     */
    private static Map<String, Map<String,Class<?>>> loaderMap = new ConcurrentHashMap<String, Map<String,Class<?>>>();

    /**
     * 对象缓存实列
     *
     */
    private static Map<String,Object> instanceCache= new ConcurrentHashMap<String,Object>();
    ...
    public static <T> T getInstance(Class<?> tClass,String key){
        ...
        if (!instanceCache.containsKey(implClassName)){//实现类不在缓存
            try {
                ...
                String errorMsg = String.format("Sorry, %s 类 实列化失败...");
